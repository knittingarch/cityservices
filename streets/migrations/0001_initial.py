# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-01-24 03:15
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(
                    ...
                    serialize=False,
                    verbose_name='ID')),
                ('neighborhood', models.CharField(choices=[
                ...
                ('suffix', models.CharField(blank=True, choices=[
                    ('St', 'Street'),
                    ('Ave', 'Avenue'),
                    ('Ter', 'Terrace'),
                    ('Hwy', 'Highway'),
                    ...
                    max_length=15,
                    null=True)),
                ('even_side_week_day', models.CharField(choices=[
                    ('M', 'Monday'),
                    ('T', 'Tuesday'),
                    ('W', 'Wednesday'),
                    ('Th', 'Thursday'),
                ...
                ('odd_side_week_day', models.CharField(choices=[
                    ('M', 'Monday'),
                    ('T', 'Tuesday'),
                    ('W', 'Wednesday'),
                    ('Th', 'Thursday'),
